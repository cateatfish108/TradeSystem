...
void MdSpi::OnRtnDepthMarketData(CThostFtdcDepthMarketDataField *pDepthMarketData)
{
	...
	//QString tradeingday = TDay[0] + TDay[1] + TDay[2] + TDay[3] + "-" + TDay[4] + TDay[5] + TDay[6] + TDay[7];//交易日
	...
	QString updatemillisec = pDepthMarketData->UpdateMillisec; //更新毫秒
	...
	QString HQTick = dm+","+ updatetime +","+lastprice+","+buyprice+","+buyvol+","+sellprice+","+sellvol+","+zf+","+vol+","+zt+","+dt+","+openprice + "," + preLastPrice + "," + tradeingday + "," + updatemillisec+ "," + datetime;	 //使用信号传递数据
